...
class HMACValidator:
    def __init__(self, incoming_hmac: str, callback_dict: Dict[str, Any], **kwargs) -> None:
        ...
        """
        self.site_hmac = kwargs.pop('site_hmac')
    ...
    def _generate_processed_hmac(self, hmac_dict: Dict[str, Any]) -> str:
        ...
        return self._calculate_hmac(message=message)
